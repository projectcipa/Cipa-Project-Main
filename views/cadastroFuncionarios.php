    ...
    <div class="container">
        <form class="cadastro-form" action="./respostaCadastroFuncionario.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="CPF_funcionario" name="CPF_funcionario" class="styled-input">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="telefone_funcionario" name="telefone_funcionario" class="styled-input">
            </div>

            <div class="form-group">
                <label for="matricula_funcionario">Matrícula</label>
                <input type="text" id="matricula_funcionario" name="matricula_funcionario" class="styled-input">
            </div>

            <div class="form-group">
                <label for="codigo_voto_funcionario">Código de Voto</label>
                <input type="text" id="codigo_voto_funcionario" name="codigo_voto_funcionario" class="styled-input">
            </div>
